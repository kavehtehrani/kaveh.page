  ...
  return (
    <div className="divide-y divide-gray-200 dark:divide-terminal-bg-lighter">
      <div className="space-y-2 pt-6 pb-8 md:space-y-5">
        <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-terminal-orange-dim dark:text-terminal-orange sm:text-4xl sm:leading-10 md:text-6xl md:leading-14 border-b border-gray-300 dark:border-terminal-bg-lighter pb-2">
          Blog
        </h1>
