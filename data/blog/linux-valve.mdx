...
game requiring hardcore anti-cheat software requiring rootkits (which I wouldn't install anyways), overwhelming majority of games
...
and AMD hardware. But in practical terms, Valve gave Linux what no distro could on its own: legitimacy, drivers
