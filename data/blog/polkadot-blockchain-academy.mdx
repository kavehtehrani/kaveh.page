...
draft: false
blogIndexInclude: false
summary: 'Reflections on an intense five-weeks of attending the Polkadot Blockchain Academy.'
authors: ['default']
---

Two days ago I graduated from the 5th cohort of the
[Polkadot Blockchain Academy (PBA)](https://polkadot.network/academy/). As I sit in the Singapore airport waiting for my
flight, I thought to use this time to reflect on the past five intense weeks at the academy.
The days were long, the material was challenging, and sleep was in short supply. And I loved every minute of it.
...
had spent quite a bit of time understanding the Polkadot ecosystem and the role of DOT in it. I have thought about
entrepreneurial pursuits in the web3 space, and building on Polkadot by
learning from the people who built it from the ground up seemed like a no-brainer. In ranks consistently
...
I first found out about the academy while doing research on DOT and Kusama in January. I applied in February and
received an entrance exam invitation in February.

## The Entrance Exam

The [PBA qualifier exam](https://github.com/Polkadot-Blockchain-Academy/pba-qualifier-exam) in itself is worth
taking even if you solely just a Rust 🦀 enthusiast! In the words of the academy itself:
...
language like JS, I think learning rust would be a pretty fairly bumpy ride.
...
[Blockchain From Scrach](https://github.com/JoshOrndorff/blockchain-from-scratch).

The instructors are all blockchain experts, with the majority coming from the Parity Technologies or Web3 Foundation.
...
times it felt like drinking from a fire hose, but the camaraderie of the group made us push through well into. There
are also office hours every day where the instructors are available to help you with any questions you might have.
To my surprise, not only were the instructors approachable and helpful, they also went out of their way frequently to
burn the midnight oil well into the night both in person and on Discord.
...
certainly helped, but it wasn't a requirement. The academy is designed to be accessible to people from all
backgrounds. The only thing you needed was a passion for learning about web3 and having learned enough Rust to not
get stuck during the academy. Rest & Rust for the win!
...
The instructors are all leading practitioners in the field as mentioned before. The last day of the Academy we had
Gavin Wood walk us through the [Gray Paper](https://wiki.polkadot.network/docs/learn-jam-chain). Finally,
we had a graduation ceremony at the National Gallery of Singapore followed by a party where
...
I put my life pretty much on hold for five weeks to attend the academy. There have been a number of sprints in my
life professionally or academically where I dedicated so much time and energy to a single goal. The academy
certainly ranks amongst the top of those sprints. I am grateful for the opportunity to attend the academy and a huge
shout-out and thank you to all the PBA staff and instructors who made thi possible. I am not aware of any other program
that offers such a comprehensive and hands-on approach to learning blockchain technology. The fact that it is funded by
...
network that I was cultivated during out time together. As far as I understand it, the academy will only get bigger
