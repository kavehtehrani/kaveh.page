...
authors: ['default']
images: '/static/images/aftab-1.png'
---
...
![LinkedIn message from scammer posing as recruiter for Galaxy Digital](/static/images/aftab-1.png)
...
![Fake job description for Portfolio Manager role, part 1](/static/images/aftab-2.png)
![Fake job description for Portfolio Manager role, part 2](/static/images/aftab-3.png)
...
![Scammer sending a ChatGPT-generated flattery message with a suspicious link](/static/images/aftab-4.png)

Alright, there is a link to some website called "talentpreview360.com". Head over to ICANN and look it up:

![ICANN lookup showing talentpreview360.com was recently registered via Hostinger](/static/images/icann-talentpreview360.png)
...
![Scam interview website landing page asking for personal details](/static/images/page-0.png)
![Scam interview website form fields for candidate information](/static/images/page-1.png)

Fill in and go to the "questions":

![Fake interview question 1 on the scam website](/static/images/question-1.png)
![Fake interview question 2 on the scam website](/static/images/question-2.png)
![Fake interview question 3 on the scam website](/static/images/question-3.png)
...
![Video recording prompt that deliberately errors out to trigger the malicious fix](/static/images/video-question.png)

I message our homeboy Aftab to see what's going on.

![LinkedIn message to scammer asking about the video recording issue](/static/images/aftab-5.png)
...
![Malicious How to Fix popup showing a fake driver update command on Windows](/static/images/how-to-fix.png)
...
![Attempting to schedule a video call with the scammer who refuses to meet](/static/images/aftab-9.png)
![Scammer dodging requests for a direct conversation on LinkedIn](/static/images/aftab-8.png)
...
![LinkedIn generic automated response closing the scam report without action](/static/images/linkedin-response.png)
...
![LinkedIn finally taking action on the scam report after multiple follow-ups](/static/images/linkedin-response-2.png)
...
![Contents of the malicious zip payload showing VBS script and hidden executables](/static/images/fixed.zip.png)
