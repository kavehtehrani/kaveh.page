...
Let's start out with a simple test. In the image below, is Stock 1 (cyan)
correlated with Stock 2 (green) positively or negatively?

<CorrChart />

If you answered postively, you are hardly alone. In fact, Stock 1 and Stock 2 have a
