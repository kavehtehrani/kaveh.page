...
[sandboxing](https://code.claude.com/docs/en/sandboxing), I have found this part of the sandbox to always be an absolutely
scary thing to read for any program that has unfettered internet access:
