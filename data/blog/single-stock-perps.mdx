...
at low fees. More importantly, given that these are derivatives on crypto rails, they would be available to anyone with a crypto wallet,
which is a far more democratic and accessible market.

### Fractional Ownership

I know fractional ownership is available now, but it is not accessible as it should be and only some brokerages offer it. This would allow you
...
experience myself with Interactive Brokers where they changed the terms of the leverage on me overnight, asking for 5x the margin without any warning.
...
Proxy wars are even more difficult.

Toeholds are common to help along the way, but they are not always effective. Options can be used to hedge the downside risk but they
have finite lives and nonlinear payouts.
...
I am competent and have built some hefty algorithmic trading systems in the past. You can read a bit more about me [here](/about).
