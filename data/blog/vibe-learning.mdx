...
date: '2025-06-05'
lastmod: "2025-06-05"
tags: ['linux', 'vibe-coding', 'apps']
draft: false
summary: 'I vibe learned and vibe coded a Speech2Text GNOME extension in a weekend.'
authors: ['default']
images: '/static/images/2025-06-chatgpt-gnome-extension.png'
---
...
![ChatGPT conversation explaining how to create a GNOME extension](/static/images/2025-06-chatgpt-gnome-extension.png)
...
![ChatGPT explaining why GNOME extensions use JavaScript instead of C, part 1](/static/images/2025-06-gnome-js-1.png)
![ChatGPT explaining why GNOME extensions use JavaScript instead of C, part 2](/static/images/2025-06-gnome-js-2.png)
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/static/images/2025-06-recording-modal.png" alt="Speech-to-text GNOME extension recording modal with live transcription" />
</div>
