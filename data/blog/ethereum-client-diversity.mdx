...
When spinning up my validator, I specifically chose [Nethermind](https://www.nethermind.io/nethermind-client), a
...
released in a few hours and everything else was up and running.

A postmortem is not available yet at the time
of this writing, so I do not know how this escaped testnet and impacted the mainnet directly. Nonetheless, kudos to the
...
other clients.
Nonetheless, staking on Ethereum was designed to be accessible for solo stakers and plenty of inexpansive consumer
grade hardware
can run a full node.
...
of Ethereum that you can do right now to protect yourself and help the network along the way.
...
* **Running 2 Ethereum Nodes** - This one is more suited to professional setups or if you are running more than one
